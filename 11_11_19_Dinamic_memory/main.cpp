...
template < typename T >int** pop_row_back(T Arr, int& m, int n) //óäàëÿåò ïîñëåäíþþ ñòðîêó
{
...
template < typename T >int** pop_row_front(T Arr, int& m, int n) //óäàëÿåò ïîñëåäíþþ ñòðîêó
{
	int** buffer = new int*[--m]{};
	for (int i = 0; i < m; i++)
	{
